...
-- SHA-1
CREATE TYPE sha1;
CREATE FUNCTION sha1_in (cstring) RETURNS sha1 LANGUAGE c STRICT AS 'hashtypes', 'sha_in1';
CREATE FUNCTION sha1_out (sha1) RETURNS cstring LANGUAGE c STRICT AS 'hashtypes', 'sha_out1';
...
-- SHA-224
CREATE TYPE sha224;
CREATE FUNCTION sha224_in (cstring) RETURNS sha224 LANGUAGE c STRICT AS 'hashtypes', 'sha_in224';
CREATE FUNCTION sha224_out (sha224) RETURNS cstring LANGUAGE c STRICT AS 'hashtypes', 'sha_out224';
...
-- SHA-256
CREATE TYPE sha256;
CREATE FUNCTION sha256_in (cstring) RETURNS sha256 LANGUAGE c STRICT AS 'hashtypes', 'sha_in256';
CREATE FUNCTION sha256_out (sha256) RETURNS cstring LANGUAGE c STRICT AS 'hashtypes', 'sha_out256';
...
-- SHA-384
CREATE TYPE sha384;
CREATE FUNCTION sha384_in (cstring) RETURNS sha384 LANGUAGE c STRICT AS 'hashtypes', 'sha_in384';
CREATE FUNCTION sha384_out (sha384) RETURNS cstring LANGUAGE c STRICT AS 'hashtypes', 'sha_out384';
...
-- SHA-512
CREATE TYPE sha512;
CREATE FUNCTION sha512_in (cstring) RETURNS sha512 LANGUAGE c STRICT AS 'hashtypes', 'sha_in512';
CREATE FUNCTION sha512_out (sha512) RETURNS cstring LANGUAGE c STRICT AS 'hashtypes', 'sha_out512';
